...
namespace IO.Swagger.Model
{
        ...
        public partial class Order :  IEquatable<Order>
    {
        ...
        public Order(string accountId = default(string), string sourceTicker = default(string), string targetTicker = default(string), decimal? amount = default(decimal?), SideEnum side = default(SideEnum))
        {
            // to ensure "sourceTicker" is required (not null)
            if (sourceTicker == null)
            {
                throw new InvalidDataException("sourceTicker is a required property for Order and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("targetTicker is a required property for Order and cannot be null");
            }
            else
            {

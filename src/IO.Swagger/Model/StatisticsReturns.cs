...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StatisticsReturns :  IEquatable<StatisticsReturns>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatisticsReturns" /> class.
        /// </summary>
        ...
        public StatisticsReturns(decimal? dAY = default(decimal?), decimal? wEEK = default(decimal?), decimal? mONTH = default(decimal?), decimal? tHREEMONTH = default(decimal?), decimal? sIXMONTH = default(decimal?), decimal? yTD = default(decimal?), decimal? yEAR = default(decimal?), decimal? aLLTIME = default(decimal?))
        {
            this.DAY = dAY;
            this.WEEK = wEEK;
            this.MONTH = mONTH;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatisticsReturns {\n");
        ...
        {
            return this.Equals(input as StatisticsReturns);
        }

        /// <summary>
        /// Returns true if StatisticsReturns instances are equal
        /// </summary>
        /// <param name="input">Instance of StatisticsReturns to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatisticsReturns input)
        {
            if (input == null)
                return false;

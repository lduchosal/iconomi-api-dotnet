...
namespace IconomiApi.Model
{
        ...
        public partial class Ticker :  IEquatable<Ticker>
    {
        ...
        /// </summary>
        [DataMember(Name="change24h", EmitDefaultValue=true)]
        public decimal? Change24h { get; set; }

        /// <summary>
        /// Gets or Sets Change7d
        /// </summary>
        [DataMember(Name="change7d", EmitDefaultValue=true)]
        public decimal? Change7d { get; set; }

        /// <summary>
        /// Gets or Sets Change1m
        /// </summary>
        [DataMember(Name="change1m", EmitDefaultValue=true)]
        public decimal? Change1m { get; set; }

        /// <summary>
        /// Gets or Sets Change3m
        /// </summary>
        [DataMember(Name="change3m", EmitDefaultValue=true)]
        public decimal? Change3m { get; set; }

        /// <summary>
        /// Gets or Sets Change6m
        /// </summary>
        [DataMember(Name="change6m", EmitDefaultValue=true)]
        public decimal? Change6m { get; set; }

        /// <summary>
        /// Gets or Sets Change12m
        /// </summary>
        [DataMember(Name="change12m", EmitDefaultValue=true)]
        public decimal? Change12m { get; set; }

        /// <summary>
        /// Gets or Sets ChangeAll
        /// </summary>
        [DataMember(Name="changeAll", EmitDefaultValue=true)]

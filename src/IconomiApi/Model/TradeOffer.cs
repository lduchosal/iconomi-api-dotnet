...
namespace IconomiApi.Model
{
        ...
        public partial class TradeOffer :  IEquatable<TradeOffer>
    {
        ...
        /// </summary>
        [DataMember(Name="sourceTicker", EmitDefaultValue=true)]
        public string SourceTicker { get; set; }

        /// <summary>
        /// Gets or Sets TargetTicker
        /// </summary>
        [DataMember(Name="targetTicker", EmitDefaultValue=true)]
        public string TargetTicker { get; set; }

        /// <summary>
        /// Gets or Sets SourceAmount
        /// </summary>
        [DataMember(Name="sourceAmount", EmitDefaultValue=true)]
        public decimal? SourceAmount { get; set; }

        /// <summary>
        /// Gets or Sets TargetAmount
        /// </summary>
        [DataMember(Name="targetAmount", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="feeTicker", EmitDefaultValue=true)]
        public string FeeTicker { get; set; }

        /// <summary>
        /// Gets or Sets SellingAssets
        /// </summary>
        [DataMember(Name="sellingAssets", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="serverTime", EmitDefaultValue=true)]

...
namespace IconomiApi.Model
{
        ...
        public partial class Transaction :  IEquatable<Transaction>
    {
        ...
        /// </summary>
        [DataMember(Name="amount_ticker", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="source_amount", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="fee_ticker", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="vat_ticker", EmitDefaultValue=true)]
        public string VatTicker { get; set; }

        /// <summary>
        /// Gets or Sets VatAmount
        /// </summary>
        [DataMember(Name="vat_amount", EmitDefaultValue=true)]
        public decimal? VatAmount { get; set; }

        /// <summary>
        /// Gets or Sets PerformanceFeeTicker
        /// </summary>
        [DataMember(Name="performance_fee_ticker", EmitDefaultValue=true)]
        public string PerformanceFeeTicker { get; set; }

        /// <summary>
        /// Gets or Sets PerformanceFeeAmount
        /// </summary>
        [DataMember(Name="performance_fee_amount", EmitDefaultValue=true)]
        public decimal? PerformanceFeeAmount { get; set; }

        /// <summary>
        /// Gets or Sets ProfitTicker
        /// </summary>
        [DataMember(Name="profit_ticker", EmitDefaultValue=true)]
        public string ProfitTicker { get; set; }

        /// <summary>
        /// Gets or Sets ProfitAmount
        /// </summary>
        [DataMember(Name="profit_amount", EmitDefaultValue=true)]
